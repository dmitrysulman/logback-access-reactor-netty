...
```kotlin
implementation("io.github.dmitrysulman:logback-access-reactor-netty-spring-boot-starter:1.1.1")
```
...
```kotlin
implementation("io.github.dmitrysulman:logback-access-reactor-netty:1.1.1")
```
