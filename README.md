...
```kotlin
implementation("io.github.dmitrysulman:logback-access-reactor-netty-spring-boot-starter:1.3.0")
```
...
- Java 21+
- Kotlin Standard Library 2.4.0
- Spring Boot Starter WebFlux 4.1.0+ (should be explicitly provided)
...
```kotlin
implementation("io.github.dmitrysulman:logback-access-reactor-netty:1.3.0")
```
